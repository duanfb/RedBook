package com.redbook.neo.ui.widget.autoviewpager;
...
/**
 * 自动滚动ViewPager
 * thanks:http://www.trinea.cn/android/auto-scroll-view-pager/
 */
public class AutoViewPager extends ViewPager {
	...
	private XDurationScroller scroller = null;
	 ...
	 */
	public void startScroll(int delayTimeInMills) {
		isAutoScroll = true;
	...
	private void setViewPagerScroller() {
		try {
			...
			scroller = new XDurationScroller(getContext(),
	...
	private static class MyHandler extends Handler {
		...
		public MyHandler(AutoViewPager autoScrollViewPager) {
			this.autoScrollViewPager = new WeakReference<AutoViewPager>(
					autoScrollViewPager);
		}
	...
	public class XDurationScroller extends Scroller {

		private double scrollFactor = 1;

		public XDurationScroller(Context context) {
			super(context);
		}

		public XDurationScroller(Context context, Interpolator interpolator) {
